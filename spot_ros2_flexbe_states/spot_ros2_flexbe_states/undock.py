...
class Undock(EventState):
        '''
        This state can be used for undocking the spot.
        ...
        def __init__(self):
                ...
                ProxyServiceCaller.initialize(Undock._node)

                self._service_topic = '/spot1/undock' # check the slash
