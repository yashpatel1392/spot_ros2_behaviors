...
class Sit(EventState):
        '''
        This state can be used for having the robot sit.
        ...
        def __init__(self):
                ...
                ProxyServiceCaller.initialize(Sit._node)

                self._service_topic = '/spot1/sit' # check the slash
