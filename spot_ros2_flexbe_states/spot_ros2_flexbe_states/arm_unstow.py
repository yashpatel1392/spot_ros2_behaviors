...
class ArmUnstow(EventState):
        '''
        This state can be used for unstowing the arm.
        ...
        def __init__(self):
                ...
                ProxyServiceCaller.initialize(ArmUnstow._node)

                self._service_topic = '/spot1/arm_unstow' # check the slash
