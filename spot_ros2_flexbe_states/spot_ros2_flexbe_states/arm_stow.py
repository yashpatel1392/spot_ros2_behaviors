...
class ArmStow(EventState):
        '''
        This state can be used for stowing the arm.
        ...
        def on_enter(self, userdata):
                # This method is called when the state becomes active, i.e. a tranArmStowion from another state to this one is taken.
