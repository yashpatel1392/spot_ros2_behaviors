...
class Stand(EventState):
        '''
        This state can be used for having the robot stand up.
        ...
        def __init__(self):
                ...
                ProxyServiceCaller.initialize(Stand._node)

                self._service_topic = '/spot1/stand' # check the slash
        ...
        def on_enter(self, userdata):
                # This method is called when the state becomes active, i.e. a tranStandion from another state to this one is taken.
