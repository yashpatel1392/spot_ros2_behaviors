...
class GripperOpen(EventState):
        '''
        This state can be used for opening the gripper.
        ...
        def __init__(self):
                ...
                ProxyServiceCaller.initialize(GripperOpen._node)

                self._service_topic = '/spot1/open_gripper' # check the slash
